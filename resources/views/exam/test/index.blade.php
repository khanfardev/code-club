    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">Test , Hello {{Auth()->user()->first_name . ' ' .Auth()->user()->last_name }}</div>
                ...
                @if($checkUser>0)
                            I have taken an exam that prevents the exam from being repeated :)
                        @else
                    <form method="POST" action="{{route('exam.test.store')}}">
                        @csrf
